...
class LabelModel extends Model{
    ...
    protected $_validate = array(
        array('title', 'require', '标签名称不能为空', self::MODEL_BOTH),
        array('title', '', '标签名称不能重复', 0, 'unique', self::MODEL_BOTH),
        array('title', '1,255', '标签名称长度不能超过255个字符', 0, 'length', self::MODEL_BOTH),
        array('url', 'require', '链接不能为空', self::MUST_VALIDATE),
    );
